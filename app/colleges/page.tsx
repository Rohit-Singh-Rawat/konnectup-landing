...
const Step = ({
	...
	return (
		<div className='bg-white p-8  shadow-sm border border-border group'>
			...
			<h3 className='text-xl font-medium text-black/90 mb-4 text-shadow-md  '>{title}</h3>
			...
			<main className=''>
					...
					<div className='container mx-auto px-4 md:px-8 lg:px-12 relative z-10'>
						<div className='max-w-3xl'>
							...
							<p className=' text-white/80 mb-8 leading-relaxed'>
								...
								hyper-personalized. It’s not just about telling students what to do; it’s about
								guiding them through a clear, step-by-step process to land their ideal role.
							</p>
							<Button className='px-8 py-3 text-lg'>Tell me more</Button>
						</div>
					</div>
				</section>
				...
				<section className='py-20  max-w-7xl mx-auto'>
					<div className='container mx-auto px-4 md:px-8 lg:px-12'>
						<div className='max-w-3xl mx-auto text-center mb-16'>
							<h2 className='text-2xl font-medium text-black/90 mb-6'>Our 3-Step Approach</h2>
							<p className=' text-black/70'>
								A comprehensive journey to help students navigate their career path from preparation
								to success.
							</p>
						</div>
				...
				<section className='py-20 bg-black/90  max-w-7xl mx-auto mb-12'>
					<div className='container mx-auto px-4 md:px-8 lg:px-12 text-center'>
						...
						<Button className='px-8 py-3 text-lg'>Book a Consultation</Button>
					</div>
				</section>
			</main>
		</div>
